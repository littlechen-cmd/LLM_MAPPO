        ...
        def update(metrics, runtime, episode_rows):
            ...
            update_row = {"real_env_steps": step,
                **{key: metrics[key] for key in (
                    ...
                    "calibration_sample_rate", "delta_g_mean",
                    "delta_g_positive_rate", "rc_confidence_mean", "semantic_loss",
                    "semantic_valid_rate", "semantic_reliability_mean",
                    "semantic_valid_denominator", "num_env_workers", "rollout_length",
                    "global_environment_steps", "environment_steps_per_second",
                    "rollout_wall_time", "policy_inference_time", "ppo_update_time",
                    "total_elapsed_time", "peak_cuda_memory_allocated",
