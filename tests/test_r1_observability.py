...
def _update(step: int) -> dict:
    return {
        ...
        "learning_rate": 3e-4,
        "astar_loss": 0.0,
        "astar_valid_rate": 0.0,
        "calibration_sample_rate": 0.0,
        "delta_g_mean": 0.0,
        "delta_g_positive_rate": 0.0,
        "rc_confidence_mean": 0.0,
        "semantic_loss": 0.0,
        "semantic_valid_rate": 0.0,
        "semantic_reliability_mean": 0.0,
...
def test_tensorboard_records_update_and_complete_episode_axes(tmp_path):
    ...
    assert {
        ...
        "train/learning_rate",
        "teacher/astar_loss",
        "teacher/astar_valid_rate",
        "teacher/calibration_sample_rate",
        "teacher/semantic_valid_rate",
        ...
        "episode/team_reward",
        "episode/collisions",
        "episode/tasks_per_1000_steps",
        "episode/episode_length",
        "episode/blocked_forward",
        "episode/energy_deaths",
    } <= tags
